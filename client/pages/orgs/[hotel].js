              ...
              {hotel.bathroom}
                ...
                <div className={style.hotel_detail_right}>
                    ...
                    <div className={style.hotel_detail_booking}>
                        <h2>Perfect for official meetings held within companies</h2>
                        <p>
                            <span>${hotel.price * options.rooms * day} </span> per 3 hours
                        </p>
...
export async function getStaticPaths() {
    const response = await axios.get(`http://localhost:4000/api/orgs`);
...
export async function getStaticProps(context) {
    ...
    console.log(params);
    const res = await axios.get(`http://localhost:4000/api/orgs/${params.hotel}`);
    const res2 = await axios.get(`http://localhost:4000/api/orgs-rooms/${params.hotel}`);

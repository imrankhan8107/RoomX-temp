  ...
  return (
    <div className={style.header}>
      <div className={style.header_main}>
        {type !== "hList" && (
          <>
            <h1>RoomX - Providing Best Property Management Solutions.</h1>
            <p></p>
            {user ? (
              <div className={style.username}>
                Welcome <b> {user.username ? user.username : user.fullname}</b>
              </div>
            ) : (
              <Link href="login">
            ...
            <div className={style.header_search}>
              ...
              <div className={style.header_search_item}>
                ...
                <span
                  ...
                  className={style.header_search_date}
                >
                    ...
                    <div className={style.search_option_item}>
                      ...
                      <div className={style.search_option_btnss}>
                        <button
                          ...
                          type="button"
                          onClick={() => handleBtn("adult", "d")}
                          disabled={options.adult <= 1}
                        >
                          -
                        </button>
                        <span className={style.option_txt_num}>
                          {options.adult}
                        </span>
                        <button
                          className={style.option_btn}
                          type="button"
                          onClick={() => handleBtn("adult", "i")}
                        >
                          +
                        </button>
                      </div>
